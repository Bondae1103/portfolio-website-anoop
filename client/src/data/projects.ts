...
export const projectsData: Project[] = [
  ...
  {
    id: "PX-05",
    title: "Enterprise Test Automation Suite (Playwright)",
    kicker: "TEST AUTOMATION / PLAYWRIGHT & AGENTIC WORKFLOWS",
    description:
      "Enterprise test automation infrastructure for cloud applications. Migrated legacy Selenium test scripts to Playwright, implementing automated refactoring, parallel test execution, and CI/CD validation pipelines.",
    stack: ["TypeScript", "Playwright", "Selenium", "Docker", "Git", "CI/CD"],
    image: "/images/fossil-signal-hero.svg",
    imageAlt: "Enterprise cloud test automation architecture with Playwright",
    imageCaption: "PLAYWRIGHT + CI/CD AUTOMATION",
    metric: "4 enterprise apps",
  ...
  {
    id: "PX-06",
    title: "Protein-Ligand Virtual Screening Pipeline",
    kicker: "COMPUTATIONAL BIOPHYSICS / AUTODOCK & PCA",
    description:
      "High-throughput computational pipeline for macromolecular docking, binding affinity scoring, and principal component analysis (PCA) of receptor trajectories to evaluate structural stability.",
    stack: ["Python", "AutoDock", "Bio3D", "PyMOL", "VMD", "Bash"],
    image: "/images/projects/md-motions-pca.webp",
    imageAlt: "Principal component analysis and virtual screening of protein trajectories",
    imageCaption: "BIO3D + AUTODOCK // 3D PCA TRAJECTORY",
    metric: "100+ docked conformations",
    github: "https://github.com/Bondae1103",
    starred: false,
    order: 3,
  },
